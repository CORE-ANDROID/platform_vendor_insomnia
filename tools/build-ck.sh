...
# get current version
eval $(grep "^CODEKILL_VERSION_" vendor/codekill/products/common.mk | sed 's/ *//g')
VERSION="$CODEKILL_VERSION_MAJOR.$CODEKILL_VERSION_MINOR.$CODEKILL_VERSION_MAINTENANCE"

# get time of startup
t1=$($DATE +%s)

echo -e ${cya}"Building ${bldppl}CODEKILL ${bldblu}INSOMNIAC$VERSION"${txtrst}
